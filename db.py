...
def seed_initial_data(clear_existing: bool = True) -> None:
    """Seed initial KRI data directly into the database (no JSON usage)."""
    with get_conn() as conn:
        if clear_existing:
        ...
        # Non-app-based KRIs (periods are quarters Qx-YYYY)
        base_points = {
            'kri2': [
                ('Q1-2025', 100.0), ('Q2-2025', 100.0)
            ],
            'kri3': [
                ('Q1-2025', 100.0), ('Q2-2025', 100.0)
            ],
            'kri4': [
                ('Q1-2025', 0.0), ('Q2-2025', 0.0)
            ],
            'kri5': [
                ('Q1-2025', 0.0), ('Q2-2025', 0.0)
            ],
            'kri6': [
                ('Q1-2025', 18.0), ('Q2-2025', 0.6)
            ],
            'kri9': [
                ('Q1-2025', 0.0), ('Q2-2025', 0.0)
            ],
            'kri15': [
                ('Q1-2025', 71.0), ('Q2-2025', 24.0)
            ],
            'kri18': [
                ('Q1-2025', 0.0), ('Q2-2025', 38.0)
            ],
            'kri20': [
                ('Q1-2025', 0.0), ('Q2-2025', 1.0)
            ],
            'kri21': [
                ('Q1-2025', 0.0), ('Q2-2025', 0.0)
            ],
            'kri22': [
                ('Q1-2025', 94.04), ('Q2-2025', 95.35)
            ],
            'kri27': [
                ('Q1-2025', 0.0), ('Q2-2025', 0.0)
            ],
            'kri28': [
                ('Q1-2025', 0.0), ('Q2-2025', 2.4)
            ],
        }

        for kri_id, items in base_points.items():
            for period, value in items:
                _insert_point(conn, kri_id, period, float(value))

        # App-based KRIs
        # kri8: value per quarter
        kri8_apps = {
            'BirBank': [('Q1-2025', 22.0), ('Q2-2025', 7.0)],
            'BirBank-Business': [('Q1-2025', 29.0), ('Q2-2025', 63.0)],
            'ODIN': [('Q1-2025', 194.0), ('Q2-2025', 285.0)],
            'ELMA BPM': [('Q1-2025', 29.0), ('Q2-2025', 13.0)],
            'Optimus': [('Q1-2025', 51.0), ('Q2-2025', 142.0)],
            'CMS': [('Q1-2025', 18.0), ('Q2-2025', 60.0)],
            'TWO': [('Q1-2025', 36.0), ('Q2-2025', 15.0)],
            'Zeus': [('Q1-2025', 45.0), ('Q2-2025', 7.0)],
        }
        for app, items in kri8_apps.items():
            for period, value in items:
                _insert_app_point(conn, 'kri8', app, period, float(value))

        # kri10: incidents per month (MM-YYYY)
        kri10_apps = {
            'BirBank-Business': [('01-2025', 1), ('02-2025', 2), ('03-2025', 1), ('04-2025', 3)],
            'BirBank': [('01-2025', 8.0), ('02-2025', 12), ('03-2025', 12), ('04-2025', 6), ('05-2025', 6), ('06-2025', 9)],
            'CMS': [('03-2025', 3), ('04-2025', 3)],
            'ELMA BPM': [('03-2025', 1), ('04-2025', 2), ('06-2025', 1)],
            'TWO': [('01-2025', 1), ('02-2025', 2), ('03-2025', 1), ('04-2025', 1), ('06-2025', 2)],
            'Zeus': [('01-2025', 3), ('02-2025', 3), ('03-2025', 2), ('04-2025', 1), ('05-2025', 4), ('06-2025', 2)],
            'Optimus': [('02-2025', 2), ('06-2025', 0)],
            'ODIN': [],
        }
        for app in kri10_apps.keys():
            conn.execute('INSERT OR IGNORE INTO kri_app_systems (kri_id, system_name) VALUES (?, ?)', ('kri10', app))
        for app, items in kri10_apps.items():
            for period, value in items:
                _insert_app_point(conn, 'kri10', app, period, float(value))

        # kri12: incidents per quarter
        kri12_apps = {
            'BirBank-Business': [('Q1-2025', 2), ('Q2-2025', 2)],
            'BirBank': [('Q1-2025', 18), ('Q2-2025', 12)],
            'CMS': [('Q1-2025', 1), ('Q2-2025', 2)],
            'ELMA BPM': [('Q1-2025', 1), ('Q2-2025', 2)],
            'TWO': [('Q1-2025', 0), ('Q2-2025', 1)],
            'Zeus': [('Q1-2025', 6), ('Q2-2025', 2)],
            'Optimus': [('Q1-2025', 1), ('Q2-2025', 0)],
            'ODIN': [('Q1-2025', 0), ('Q2-2025', 0)],
        }
        for app, items in kri12_apps.items():
            for period, value in items:
                _insert_app_point(conn, 'kri12', app, period, float(value))

        # kri13: value per quarter
        kri13_apps = {
            'BirBank': [('Q1-2025', 14), ('Q2-2025', 9)],
            'BirBank-Business': [('Q1-2025', 2), ('Q2-2025', 1)],
            'ODIN': [('Q1-2025', 0), ('Q2-2025', 0)],
            'ELMA BPM': [('Q1-2025', 0), ('Q2-2025', 1)],
            'Optimus': [('Q1-2025', 1), ('Q2-2025', 0)],
            'CMS': [('Q1-2025', 2), ('Q2-2025', 1)],
            'TWO': [('Q1-2025', 4), ('Q2-2025', 2)],
            'Zeus': [('Q1-2025', 1), ('Q2-2025', 5)],
        }
        for app, items in kri13_apps.items():
            for period, value in items:
                _insert_app_point(conn, 'kri13', app, period, float(value))

        # kri19: value per quarter (minutes)
        kri19_apps = {
            'BirBank': [('Q1-2025', 3125.9), ('Q2-2025', 3973.4)],
            'BirBank-Business': [('Q1-2025', 407.5), ('Q2-2025', 1811.0)],
            'ODIN': [('Q1-2025', 0.0), ('Q2-2025', 0.0)],
            'ELMA BPM': [('Q1-2025', 269.0), ('Q2-2025', 892.3)],
            'Optimus': [('Q1-2025', 207.5), ('Q2-2025', 0.0)],
            'CMS': [('Q1-2025', 73.0), ('Q2-2025', 644.0)],
            'TWO': [('Q1-2025', 31.25), ('Q2-2025', 353.6)],
            'Zeus': [('Q1-2025', 1734.4), ('Q2-2025', 59.1)],
        }
        for app, items in kri19_apps.items():
            for period, value in items:
                _insert_app_point(conn, 'kri19', app, period, float(value))
